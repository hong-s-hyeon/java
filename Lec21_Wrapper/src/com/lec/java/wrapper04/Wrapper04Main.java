...
public class Wrapper04Main {
	...
	public static void main(String[] args) {
		...
		// TODO
//		long numLong = 3918479238749284752934759234579234875L;  // error : Long number too large

		BigInteger num1 = new BigInteger("3918479238749284752934759234579234875");
		System.out.println(num1);
		System.out.println(num1.intValue());
		System.out.println(num1.max(new BigInteger("4985723495872349587234968729348759234572934857")));
