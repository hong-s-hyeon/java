...
public class String01Main {
	...
	public static void main(String[] args) {
		...
		System.out.println("바뀌엇나?  >> " + str1);

		// ★주의★
		// empty 문자열과 null 은 다르다
		// null 인 경우 메소드 수행하면 NullPointerException 발생!
		String str3 = "";  // empty 문자열, 문자열 객체 존재하나 비어있는 문자열
		System.out.println(str3.length());
		str3 = null;   // null, 문자열 객체가 존재하지 않음.
//		System.out.println(str3.length());  //  NPE >> null.~~~~~() > NullPointException~!
//		NullPointerException: Cannot invoke "String.length()" because "str3" is null
//		at com.lec.java.string01.String01Main.main(String01Main.java:49)
...
//		System.out.println(str1.charAt(20)); // StringIndexOutOfBoundsException: index 20, length 13
//		at com.lec.java.string01.String01Main.main(String01Main.java:59)
		...
		System.out.println(str1.indexOf('c')); // 없으면 -1 리턴
		...
		System.out.println("http://www.aaa.com".startsWith(prefix)); // true
		...
		String [] strings = str4.split(":");  // [HH, MM, SS]
		System.out.println(strings); // [Ljava.lang.String;@4dd8dc3
		...
		System.out.println(String.join("33", str7));
...
//		System.out.println(str9.strip());
		...
		System.out.println(str10.replaceAll("Language", "자바"));  // 매칭되는거 전부 치환
