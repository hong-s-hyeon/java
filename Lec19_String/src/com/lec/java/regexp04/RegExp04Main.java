...
public class RegExp04Main {
    ...
    public static void main(String[] args) {
        ...
        // 알파벳은 대소문자 구문 없슴
        // 숫자는 0으로 시작하면 안됨.
        String regex = "^(?i)([a-z]{2})-([0-9]{4})-([1-9][0-9]{2})-([a-z]{3})$";
        ...
        while (true) {
            ...
            if (coupon.equalsIgnoreCase("quit")) break;

            matcher = pat.matcher(coupon);
            if (matcher.find()) System.out.println("유효한 쿠폰입니다.");
            else System.out.println("유효한 쿠폰이 아닙니다.");
