...
public class Generic01Main {
	...
	public static void main(String[] args) {
		...
		BananaBox bananaBox1 = new BananaBox(banana);
		...
		// 동작은 같은데,,, 이게 들어오는 데이터 타입이 다르네?
		// 이럴 때 만들면 좋은 클래스!  138 라인으로 이동
		...
		FruitBox<Apple> appleBox2 = new FruitBox<>(apple2);
		appleBox2.pullOut().displayWeight();

		Banana banana2 = new Banana(100);
		FruitBox<Banana> bananaBox2 = new FruitBox<>(banana2);
...
class OrangeBox{
	...
	public Orange pullOut(){return this.orange;}
}
...
class AppleBox{
	...
	public Apple pullOut(){return this.apple;}
}
